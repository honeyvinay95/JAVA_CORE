...
<body>
       ...
       <td><b>${sum}</td>
             ...
             <a href = "${session.getContextPath()}/E-commerce_frontend/thankyou/${prod.id}" input class="btn btn-info" name="_eventId_submit" type="submit"value="Next" /> Next</a>
             <!-- <input class="btn btn-info" name="_eventId_submit" type="submit"value="Next" /> -->
        </div>
         </div>
        
       <div class="container">
       <a href="http://localhost:8080/E-commerce_frontend/"input class="btn btn-success" name="_eventId_submit" type="submit"value="BACK TO HOME" >BACK TO HOME</a>
